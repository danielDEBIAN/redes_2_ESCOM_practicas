...
public class Server
{
    ...
    public Server() throws NumberFormatException, IOException
    {
        ...
        try{
            ...
            System.out.println(" ");
            System.out.println("Esperando conexion de los clientes");
        }
        catch(IOException e)
        {
            e.printStackTrace();
...
class ServerTestClass extends Thread
{
    ...
    public void run()
    {
        try
        {
            ...
            System.out.println("Todos los archivos disponibles de la ruta fueron recibidos al servidor");
            for(int i=0;i<filesList.size() ;i++)
            {
                globalArray.add(filesList.get(i));
            }
            System.out.println("Numero total de archivos disponibles en el servidor que fueron recibidos de los clientes conectados: " +globalArray.size());
        }
        ...
        System.out.println("Buscando el archivo...");
